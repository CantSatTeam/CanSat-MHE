...
if __name__ == '__main__':
    ...
    test_dataloader = DataLoader(dataset=test_dataset, batch_size=1,num_workers=0,
                                  pin_memory=True,drop_last=True) # formerly batch_size=6,num_workers=args.num_workers
    '''
    Training model
    '''
